     ...
     const Text(
        ...
        style: TextStyle(
          ...
          fontWeight: FontWeight.w500,
            ...
            ItemProfile(title: 'تعديل الملف الشخصي',onPress: (){AppNavigation.navigateTo(context, EditProfileScreen());},icon: Images.edit,),
            ItemProfile(title: 'العنوان',onPress: (){},icon: Images.location,),
            ItemProfile(title: 'من نحن',onPress: (){},icon: Images.users,),
            ItemProfile(title: 'الدعم الفني',onPress: (){},icon: Images.call,),
      ...
      InkWell(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              Image.asset(Images.logout ,width: 16,height: 16,),
              SizedBox(width: 12,),
              Text(
                'تسجيل الخروج',
                textAlign: TextAlign.right,
